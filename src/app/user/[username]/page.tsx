...
export default async function UserPage({ params: { username } }: Props) {
  ...
  return (
    <section className="overflow-y-auto flex flex-col md:flex-row justify-center max-w-screen-2xl gap-[16px] w-full py-[16px]">
      <div className="min-w-[340px] bg-white min-h-[100dvh] h-full sm:pt-[30px] pt-[24px] sm:mb-[30px] mb-[20px] max-w-[935px] w-[calc(100%-40px)] rounded-xl sm:px-[20px] px-[12px]">
